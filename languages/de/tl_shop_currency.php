 ...
 * Buttons
 **/
$GLOBALS['TL_LANG']['tl_shop_currency']['new']    = array('Neue Währung', 'new');
$GLOBALS['TL_LANG']['tl_shop_currency']['edit']   = array('edit', 'Währung ID %s bearbeiten');
$GLOBALS['TL_LANG']['tl_shop_currency']['copy']   = array('copy', 'Währung ID %s duplizieren');
$GLOBALS['TL_LANG']['tl_shop_currency']['delete'] = array('delete', 'Währung ID %s l&oumlschen');
$GLOBALS['TL_LANG']['tl_shop_currency']['show']   = array('show', 'Details der Währung ID %s anzeigen');
